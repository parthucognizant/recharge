...
import com.cognizant.cogcharge.parser.JSONParser;
	...
	class AttemptRegister extends AsyncTask<String, String, Boolean> {
		...
		protected Boolean doInBackground(String... params) {
			try{
				...
				jsonObject.accumulate("user_id","357761");
		...
		protected void onPostExecute(Boolean result) {
			...
			if(result){
				...
				Intent homeintetnt = new Intent(RegisterNumberActivity.this, MainActivity.class);
